    ...
    <footer className="Footer">
      <div className="footer-line">
        <div className="footer-infos">
          <h4>Contato:</h4>
          <p>
            <strong>Luciano Graciano Leite</strong>
            <br />
            Endereço do Escritório:
            <br />
            Sabará, MG, 34.505-030
            <br />
        ...
        <div className="footer-infos" id="footer-map">
          <p>Onde estou:</p>
          <iframe
            ...
            style={{ border: 0, borderRadius: 5, height: 100, width: "100%" }}
            loading="lazy"
